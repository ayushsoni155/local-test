...
export default defineConfig({
  ...
  test: {
    ...
    // jsdom gives you a browser-like DOM for React component tests
    environment: "jsdom",
    // Global test APIs (describe, it, expect) without importing them each time
    globals: true,
    // Load .env.test if it exists (never commit real secrets)
